  ...
  await sql.schema.createTable(tableName, (table) => {
    switch (tableName) {
      ...
      case this.tables.userProfiles:
        ...
        table.foreign('userId').references('userId').inTable(this.tables.users).onDelete("CASCADE").onUpdate("NO ACTION");
      ...
      case this.tables.trips:
        ...
        table.foreign('owner').references('userId').inTable(this.tables.users).onDelete("CASCADE").onUpdate("NO ACTION");
      ...
      case this.tables.pings:
        ...
        table.foreign('trip').references('tripId').inTable(this.tables.trips).onDelete("CASCADE").onUpdate("NO ACTION");
        table.integer('type').notNullable();
        table.float('latitude', 14, 8).notNullable();
        table.float('longitude', 14, 8).notNullable();
        table.float('altitude', 14, 8).notNullable();
      ...
      case this.tables.photos:
        ...
        table.foreign('ping').references('pingId').inTable(this.tables.pings).onDelete("CASCADE").onUpdate("NO ACTION");

...
function sortByDistance(venues) {
  return venues.sort((v1, v2) => v1.location.distance - v2.location.distance);
}
...
exports.getAllVenues = async (req, res) => {
  try {
    ...
    const venueResponse = sortByDistance(venueRequest.data.response.venues);
